...
import (
	models 	"DTS-Kominfo-Hactiv8/Chapter3/Challange3/models"
...
func (_m *ProductRepository) FindAll() []*models.Product {
	ret := _m.Called()
...
func (_m *ProductRepository) FindById(id string) *models.Product {
	ret := _m.Called(id)
